    ...
    return Scaffold(
      ...
      body: ListView(children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage(
                  '${widget.model.displayedEvents[widget.eventIndex].image}'),
            ),
          ),
        ),
        ListTile(
          ...
          subtitle: Text(
              '${widget.model.displayedEvents[widget.eventIndex].description}'),
          onTap: () {},
        ),
        ListTile(
          title: Text(
        ...
        ListTile(
          ...
          subtitle: Text(
              '${widget.model.displayedEvents[widget.eventIndex].startDateTime}'),
          onTap: () {},
        ),
        ListTile(
          title: Text(
          ...
          subtitle: Text(
              '${widget.model.displayedEvents[widget.eventIndex].endDateTime}'),
          onTap: () {},
        ),
        ListTile(
          title: Text(
          ...
          subtitle:
              Text('${widget.model.displayedEvents[widget.eventIndex].hostID}'),
          onTap: () {},
        ),
        ListTile(
          title: Text(
          ...
          subtitle: Text(
              '${widget.model.displayedEvents[widget.eventIndex].hostEmail}'),
          onTap: () {},
        ),
        Center(
              ...
              return model.isLoading
                  ...
                  : RaisedButton(
                      ...
                      child: Text(model.allEvents[widget.eventIndex].attendees
                          ...
                          : 'REACH'),
                      onPressed: () {
                        widget.model.reachEvent(
                            model.displayedEvents[widget.eventIndex]);
                      },
                    );
            },
          ),
